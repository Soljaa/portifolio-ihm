<template>
    <div class="persona">
        ...
        <h2 class="portfolio-title">Marcelo Villa</h2>
        </header>
        ...
        <div class="left-column">
            ...
            <p>Idade: <strong>24</strong></p>
            <p>Curso: <strong>Ciência da Computação</strong></p>
            <p>Período: <strong>7º Período</strong></p>
            <p>
                Cidade:
        ...
        <div class="right-column">
            ...
            <ul>
                <li>Registrar suas horas complementares.</li>
                <li>
            ...
            <ul>
                <li>Tem grupos de whatsapp com colegas de curso.</li>
                <li>

<template>
    <div class="persona">
        ...
        <h2 class="portfolio-title">Natália Fernandes</h2>
        </header>
        ...
        <div class="middle-column">
            ...
            <ul>
                <li>Garantir um alto rendimento na faculdade.</li>
                <li>
